-- ============================================================
-- AUDITORÍA: resumen legible para catálogos de calculadoras
-- ============================================================
-- Mismo auditar_cambio() de 20260987090000, solo se agregan los case
-- de 'tipos_bobina', 'formula_variantes', 'formula_insumos' y
-- 'tipos_conteo_peso' para que el resumen no caiga en el default
-- (tg_table_name pelado).
-- ============================================================
