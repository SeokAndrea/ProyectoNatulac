-- ============================================================
-- DEBUG: exponer volumenes_lote_cierre en turno_json()
-- ============================================================
-- Para poder verificar desde afuera (sin psql/service-role) si el
-- trigger de freeze (20260968, reafirmado en 20261009) realmente
-- está escribiendo algo al cerrar un turno. Hasta ahora turno_json()
-- usaba esta columna solo INTERNAMENTE (para decidir qué volumen_l
-- mostrar en preparaciones) pero nunca la devolvía como campo propio
-- — así que no había forma de confirmar desde la API si el snapshot
-- se estaba tomando o no. Puramente aditivo: un campo más en el JSON,
-- nada más.
-- ============================================================
