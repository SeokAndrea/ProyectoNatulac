...
| **§2.6** | *Hecho:* Contador 2 (envases buenos) obligatorio en el form de PT, no puede superar la llenadora (`aa8a9ea`... `8fdcf42`); guard equivalente del lado servidor en `registrar_contador` (`20261036`, 2026-09-11). *Falta:* mostrar el `Δenvases` visible en toda corrida. |
