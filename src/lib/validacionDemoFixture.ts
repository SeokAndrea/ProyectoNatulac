...
export const FILAS_VALIDACION_DEMO: FilaValidacion[] = [
  {
    ...
    /** Demo del badge nuevo: comparte línea+lote+presentación con "tl6" más abajo. */
  ...
  {
    turnoLineaId: "tl6",
    turnoCodigo: `A${dia(0).replace(/-/g, "")}_T1G3`,
    fecha: dia(0),
    supervisorNombre: "Rosa Delgado",
    areaNombre: "Producción Aséptico",
    linea: "Línea 1",
    presentacion: "1000 ml",
    sabor: "Manzana 35%",
    ...
    sinPt: false,
    cierreAutomatico: false,
    /** Comparte línea+lote+presentación con "tl1" — puede ser que la línea siguió con el resto del lote, o un duplicado real; VALIDAR lo marca para revisar, no lo bloquea. */
    posibleDuplicado: true,
    supervisor: valores({ ...P1000, paletas: 3, cajasSueltas: 10, envasesLlenadora: 1800 }),
    overrides: null,
    validadoPorNombre: null,
    validadoEn: null,
  },
